...
def register_model(model_name: str, model_info: dict):
    ...
    try:
        # Use the model_uri directly (saved from log_model return value)
        model_uri = model_info['model_path']  # This now contains the full model URI
        ...
        # In MLflow 3.x, use set_registered_model_alias instead of deprecated stage transitions
